...
require (
	...
	github.com/quantumauth-io/quantum-go-utils v0.0.16
...
require (
	...
	go.elastic.co/apm/module/apmpgx/v2 v2.7.2 // indirect
	go.elastic.co/apm/module/apmsql/v2 v2.7.2 // indirect
